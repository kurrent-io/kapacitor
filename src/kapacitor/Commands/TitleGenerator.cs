...
static partial class TitleGenerator {
    ...
    /// </summary>
    internal const string TitlePromptPrefix =
    ...
    /// Also used by <see cref="IsKnownKapacitorPrompt"/> to detect kapacitor sub-sessions.
    /// </summary>
    internal const string WhatsDonePromptPrefix =
    ...
    static string BuildPrompt(string userText, string? assistantText) {
        ...
        sb.Append(TitlePromptPrefix);
        sb.Append("NEVER ask a question. NEVER include a question mark. Always produce a title, even if context is limited.");
