...
/// </summary>
public static class SharedConfigDirCleanup {
    ...
    /// </summary>
    public static void ClearWithRetry(string what, Action delete) {
        Exception? last = null;
    ...
    /// </summary>
    public static void ClearTokenAndProfileState(string legacyTokensPath, string tokensDir) {
