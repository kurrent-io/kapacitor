...
public sealed class RecordingAuthProgress : IAuthProgress {
    ...
    public List<(string Code, string Uri)> DeviceCodes     { get; } = [];
    ...
    public void DeviceCode(string code, string verificationUri, string? provider, bool prefilled) => DeviceCodes.Add((code, verificationUri));
