...
public class CursorWatcherSpawnTests {
    ...
    // (it asserts `spawned` is empty until the drain delivers, then asserts the {parent}-{child}
    // key) and by Later_nonterminal_child_hook_does_not_spawn_when_never_acked.
    //
